package uxdesign.cafemap.Common.Response.status;
...
public enum BaseExceptionResponseStatus implements ResponseStatus {
    ...
    UNSUPPORTED_AUTHORIZATIONCODE_TYPE(4003, HttpStatus.UNAUTHORIZED.value(), "OAuth Authorization Code의 형식이 올바르지 않습니다."),
    UNSUPPORTED_TOKEN_TYPE(4004, HttpStatus.BAD_REQUEST.value(), "지원되지 않는 토큰 형식입니다."),
    INVALID_TOKEN(4005, HttpStatus.UNAUTHORIZED.value(), "유효하지 않은 토큰입니다."),
    MALFORMED_CODE(4006, HttpStatus.UNAUTHORIZED.value(), "Authorization Code가 올바르게 구성되지 않았습니다."),
    MALFORMED_TOKEN(4007, HttpStatus.UNAUTHORIZED.value(), "토큰이 올바르게 구성되지 않았습니다."),
    EXPIRED_CODE(4008, HttpStatus.UNAUTHORIZED.value(), "만료된 Authorization Code입니다."),
    EXPIRED_TOKEN(4008, HttpStatus.UNAUTHORIZED.value(), "만료된 토큰입니다."),
    TOKEN_MISMATCH(4009, HttpStatus.UNAUTHORIZED.value(), "로그인 정보가 토큰 정보와 일치하지 않습니다."),
    INVALID_CLAIMS(4010, HttpStatus.UNAUTHORIZED.value(), "OAuth Claims 값이 올바르지 않습니다."),
